...
@Schema(name = "ProductOrderRef", description = "ProductOrder (ProductOrder) .The product order which the recommendation is related with.")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.10.0")
public class ProductOrderRef implements Serializable {
  ...
  public ProductOrderRef atBaseType(String atBaseType) {
  ...
  public ProductOrderRef atSchemaLocation(URI atSchemaLocation) {
  ...
  public ProductOrderRef atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productOrderRef.id) &&
        ...
        Objects.equals(this.atBaseType, productOrderRef.atBaseType) &&
        Objects.equals(this.atSchemaLocation, productOrderRef.atSchemaLocation) &&
        Objects.equals(this.atType, productOrderRef.atType) &&
        Objects.equals(this.atReferredType, productOrderRef.atReferredType);
  }
