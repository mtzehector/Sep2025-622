...
public class RelatedChannel implements Serializable {
  ...
  public RelatedChannel atSchemaLocation(URI atSchemaLocation) {
  ...
  public RelatedChannel atReferredType(String atReferredType) {
