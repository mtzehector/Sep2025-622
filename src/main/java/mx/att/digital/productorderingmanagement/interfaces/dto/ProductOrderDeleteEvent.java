...
public class ProductOrderDeleteEvent implements Serializable {
  ...
  public ProductOrderDeleteEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOrderDeleteEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOrderDeleteEvent eventId(String eventId) {
  ...
  public ProductOrderDeleteEvent eventTime(OffsetDateTime eventTime) {
  ...
  public ProductOrderDeleteEvent eventType(String eventType) {
  ...
  public ProductOrderDeleteEvent correlationId(String correlationId) {
  ...
  public ProductOrderDeleteEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOrderDeleteEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOrderDeleteEvent description(String description) {
  ...
  public ProductOrderDeleteEvent priority(String priority) {
  ...
  public ProductOrderDeleteEvent timeOcurred(OffsetDateTime timeOcurred) {
  ...
  public ProductOrderDeleteEvent event(ProductOrderDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  public void setEvent(ProductOrderDeleteEventPayload event) {
    this.event = event;
  }
