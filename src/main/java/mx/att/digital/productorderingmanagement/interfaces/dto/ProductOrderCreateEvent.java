...
public class ProductOrderCreateEvent implements Serializable {
  ...
  public ProductOrderCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  public ProductOrderCreateEvent timeOcurred(OffsetDateTime timeOcurred) {
