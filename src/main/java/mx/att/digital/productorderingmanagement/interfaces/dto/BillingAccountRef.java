...
@Schema(name = "BillingAccountRef", description = "BillingAccount reference. A BillingAccount is a detailed description of a bill structure.")
...
public class BillingAccountRef implements Serializable {
   ...
   */
  @NotNull 
  @Schema(name = "id", description = "Unique identifier of the billing account", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  @Schema(name = "href", description = "Reference of the billing account", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("href")
  ...
  @Schema(name = "name", description = "Name of the billing account", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
  ...
  public BillingAccountRef atBaseType(String atBaseType) {
  ...
  public BillingAccountRef atSchemaLocation(URI atSchemaLocation) {
  ...
  public BillingAccountRef atType(String atType) {
    this.atType = atType;
    return this;
  }
