...
@Schema(name = "CancelProductOrderCreateEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.10.0")
public class CancelProductOrderCreateEvent implements Serializable {
  ...
  private CancelProductOrderCreateEventPayload event;

  public CancelProductOrderCreateEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent eventId(String eventId) {
  ...
  public CancelProductOrderCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  public CancelProductOrderCreateEvent eventType(String eventType) {
  ...
  public CancelProductOrderCreateEvent correlationId(String correlationId) {
  ...
  public CancelProductOrderCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent description(String description) {
  ...
  public CancelProductOrderCreateEvent priority(String priority) {
  ...
  public CancelProductOrderCreateEvent timeOcurred(OffsetDateTime timeOcurred) {
  ...
  public CancelProductOrderCreateEvent event(CancelProductOrderCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public CancelProductOrderCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(CancelProductOrderCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelProductOrderCreateEvent cancelProductOrderCreateEvent = (CancelProductOrderCreateEvent) o;
  ...
  public String toString() {
    ...
    sb.append("class CancelProductOrderCreateEvent {\n");
