...
@Schema(name = "ProductOrderAttributeValueChangeEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.10.0")
public class ProductOrderAttributeValueChangeEvent implements Serializable {
