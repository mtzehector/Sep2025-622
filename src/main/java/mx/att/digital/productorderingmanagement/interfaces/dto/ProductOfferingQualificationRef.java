...
@Schema(name = "ProductOfferingQualificationRef", description = "It's a productOfferingQualification that has been executed previously")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.10.0")
public class ProductOfferingQualificationRef implements Serializable {
