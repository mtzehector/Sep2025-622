...
@Schema(name = "ProductOrderInformationRequiredEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.10.0")
public class ProductOrderInformationRequiredEvent implements Serializable {
  ...
  public ProductOrderInformationRequiredEvent eventTime(OffsetDateTime eventTime) {
  ...
  public ProductOrderInformationRequiredEvent timeOcurred(OffsetDateTime timeOcurred) {
