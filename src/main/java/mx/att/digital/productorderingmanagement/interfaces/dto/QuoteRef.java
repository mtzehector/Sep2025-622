...
@Schema(name = "QuoteRef", description = "It's a Quote that has been executed previously")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.10.0")
public class QuoteRef implements Serializable {
  ...
  public QuoteRef name(String name) {
    this.name = name;
    return this;
  }
  ...
  public QuoteRef atBaseType(String atBaseType) {
  ...
  public QuoteRef atSchemaLocation(URI atSchemaLocation) {
  ...
  public QuoteRef atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public QuoteRef atReferredType(String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, quoteRef.id) &&
        ...
        Objects.equals(this.name, quoteRef.name) &&
        Objects.equals(this.atBaseType, quoteRef.atBaseType) &&
        Objects.equals(this.atSchemaLocation, quoteRef.atSchemaLocation) &&
        Objects.equals(this.atType, quoteRef.atType) &&
        Objects.equals(this.atReferredType, quoteRef.atReferredType);
  }
